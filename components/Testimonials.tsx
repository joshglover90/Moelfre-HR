...
const reviews = [
  ...
  },
  {
    ...
    rating: 5,
    date: "July 2024",
    text: "The views are breathtaking. We watched seals from the window every morning! The hosts were incredibly helpful with local recommendations. Can't recommend highly enough.",
    avatar: "DL",
  ...
  },
  {
    name: "Emma R.",
    location: "London",
    property: "Ty Hir Caravan",
    rating: 5,
    date: "September 2024",
    text: "A perfect coastal escape. Cosy, well-equipped, and utterly charming. The coastal path right nearby meant we walked every day. The local pub was fantastic for evenings. Already missing it.",
    avatar: "ER",
  ...
  },
  {
    ...
    location: "Birmingham",
    property: "No 1 Rhos Fford",
    rating: 5,
    date: "June 2024",
    text: "A brilliant base for a family holiday. Right in the heart of the village, steps from the beach. The owners were brilliant — nothing was too much trouble. Anglesey is just stunning.",
    avatar: "WF",
